...
<head>
    ...
    <link
        rel="stylesheet"
        href="../../styles/admin/admin-prestamos-page.css" />
...
<body>
        ...
        <nav class="nav-section">
            <ul class="nav-options-list">
                <li class="nav-element">
                    <a href="../admin/admin-principal-page.php">
    ...
    <main>
        <section class="container-prestamos">
            <header class="header-prestamos">
                <h1>Prestamos</h1>
            </header>
            <div class="prestamos-card-container">
                <article class="prestamo-card prestamo-activo">
                    <div class="id-prestamo-container">
                       <h4>ID Prestamo: </h4> <h4>1</h4>
                    </div>
                    <div class="estado-prestamo-container">
                        <h5>Estado :</h5> <h5>Activo</h5>
                    </div>
                ...
                <article class="prestamo-card prestamo-vencido">
                    <div class="id-prestamo-container">
                       <h4>ID Prestamo: </h4> <h4>1</h4>
                    </div>
                    <div class="estado-prestamo-container">
                        <h5>Estado :</h5> <h5>Vencido</h5>
                    </div>
                    <div class="info-prestamo-container">
                        <div>
                            <h5>Se presto el:</h5>
