        ...
        <section class="prestamos-historial">
            ...
            <div class="prestamos-container">
                <?php
                        ...
                        $sqlPrestamos = "SELECT libros.titulo ,libros.autor , prestamos.fecha_prestamo , prestamos.fecha_devolucion,prestamos.fecha_entrega FROM prestamos JOIN libros ON prestamos.isbn = libros.isbn WHERE prestamos.id_profesor = :idUsuario ORDER BY prestamos.fecha_prestamo DESC ";
