    ...
    <main>
        <section class="multas-historial">
            ...
            <div class="multas-container">
                ...
                $sql = "SELECT l.isbn, l.titulo, l.autor,l.imagen, m.cantidad, m.fecha_pago , m.fecha_generacion FROM libros l JOIN prestamos p ON l.isbn = p.isbn JOIN multas m ON p.multa = m.id_multa WHERE p.id_estudiante = :idUsuario AND m.cantidad IS NOT NULL";
